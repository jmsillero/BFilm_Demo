...
class FilmsGridAdapter() : RecyclerView.Adapter<FilmsGridAdapter.ItemFilmViewHolder>() {
    private val films: MutableList<Film> = mutableListOf()


    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemFilmViewHolder {
        return ItemFilmViewHolder(FilmItemView(parent.context))
    }
    ...
    class ItemFilmViewHolder(private val itemView: FilmItemView) :
